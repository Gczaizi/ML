...
def loadDataSet():
    dataMat = []
    labelMat = []
    fr = open('/mnt/e/Study/data/testSet.txt')
...
def plotBestFit(wei):
    ...
    plt.xlabel('X1')
    plt.ylabel('X2')
    plt.savefig('logregres_stoc.png')
...
def colicTest():
    frTrain = open('/mnt/e/Study/data/horseColicTraining.txt')
    frTest = open('/mnt/e/Study/data/horseColicTest.txt')
    trainingSet = []
    trainingLabels = []
